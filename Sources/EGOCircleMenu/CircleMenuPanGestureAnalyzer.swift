...
class CircleMenuPanGestureAnalyzer {
	...
	private static let minLength = 30.0
	private var pointStart = CGPoint.zero
	private var pointEnd = CGPoint.zero
